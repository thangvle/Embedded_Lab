...
HD_PWD='C:/vivado_proj/lab_3/lab_3.runs/design_interrupt_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_interrupt_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_interrupt_rst_ps7_0_100M_0.tcl
