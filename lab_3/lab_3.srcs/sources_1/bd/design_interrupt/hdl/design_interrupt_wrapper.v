...
//Date        : Tue Feb 19 09:57:14 2019
//Host        : DESKTOP-P52MVK7 running 64-bit major release  (build 9200)
//Command     : generate_target design_interrupt_wrapper.bd
//Design      : design_interrupt_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_interrupt_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  design_interrupt design_interrupt_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
