...
HD_PWD='D:/vivado_proj/Embedded_Lab/lab_5/vivado_lab5/vivado_lab5.runs/design_1_PmodACL2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodACL2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodACL2_0_0.tcl
