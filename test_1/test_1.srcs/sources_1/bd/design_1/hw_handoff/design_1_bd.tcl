...
proc create_root_design { parentCell } {
  ...
  set led4bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 led4bits ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports led4bits] [get_bd_intf_pins axi_gpio_0/GPIO]
