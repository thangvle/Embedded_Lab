...
set C_modelArgList {
	...
	{ fb_offset int 32 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "fb", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "fb_offset", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fb_offset_dout sc_in sc_lv 32 signal 1 } 
	{ fb_offset_empty_n sc_in sc_logic 1 signal 1 } 
	{ fb_offset_read sc_out sc_logic 1 signal 1 } 
	{ img_rows_V_dout sc_in sc_lv 12 signal 2 } 
	{ img_rows_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ img_rows_V_read sc_out sc_logic 1 signal 2 } 
	{ img_cols_V_dout sc_in sc_lv 12 signal 3 } 
	{ img_cols_V_empty_n sc_in sc_logic 1 signal 3 } 
	{ img_cols_V_read sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fb_offset_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fb_offset", "role": "dout" }} , 
 	{ "name": "fb_offset_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fb_offset", "role": "empty_n" }} , 
 	{ "name": "fb_offset_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fb_offset", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "fb", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Array2Mat_fu_140", "Port" : "fb"}]},
			{"Name" : "fb_offset", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
			...
			{"Name" : "img_data_stream_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Array2Mat_fu_140", "Port" : "img_data_stream_V"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Array2Mat_fu_140", "Parent" : "0",
		"CDFG" : "Array2Mat",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "2085482"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "2085482"}
]}
...
set Spec2ImplPortList { 
	...
	fb_offset { ap_fifo {  { fb_offset_dout fifo_data 0 32 }  { fb_offset_empty_n fifo_status 0 1 }  { fb_offset_read fifo_update 1 1 } } }
