...
set portList { 
	...
	{ fb_offset_dout sc_in sc_lv 32 signal 2 } 
	{ fb_offset_empty_n sc_in sc_logic 1 signal 2 } 
	{ fb_offset_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "img_data_stream_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Array_fu_60", "Port" : "img_data_stream_V"}]},
			{"Name" : "fb", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Array_fu_60", "Port" : "fb"}]},
			{"Name" : "fb_offset", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "fb_offset_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Array_fu_60", "Parent" : "0",
		"CDFG" : "Mat2Array",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2083322", "Max" : "2083322"}
	, {"Name" : "Interval", "Min" : "2083322", "Max" : "2083322"}
]}
