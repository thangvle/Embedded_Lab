...
struct Mat2AXIM : public sc_module {
    ...
    sc_signal< sc_lv<32> > fb_offset_read_reg_70;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_ap_start;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_ap_done;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_ap_idle;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_ap_ready;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_img_data_stream_V_read;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_m_axi_fb_AWVALID;
    sc_signal< sc_lv<32> > grp_Mat2Array_fu_60_m_axi_fb_AWADDR;
    sc_signal< sc_lv<1> > grp_Mat2Array_fu_60_m_axi_fb_AWID;
    sc_signal< sc_lv<32> > grp_Mat2Array_fu_60_m_axi_fb_AWLEN;
    sc_signal< sc_lv<3> > grp_Mat2Array_fu_60_m_axi_fb_AWSIZE;
    sc_signal< sc_lv<2> > grp_Mat2Array_fu_60_m_axi_fb_AWBURST;
    sc_signal< sc_lv<2> > grp_Mat2Array_fu_60_m_axi_fb_AWLOCK;
    sc_signal< sc_lv<4> > grp_Mat2Array_fu_60_m_axi_fb_AWCACHE;
    sc_signal< sc_lv<3> > grp_Mat2Array_fu_60_m_axi_fb_AWPROT;
    sc_signal< sc_lv<4> > grp_Mat2Array_fu_60_m_axi_fb_AWQOS;
    sc_signal< sc_lv<4> > grp_Mat2Array_fu_60_m_axi_fb_AWREGION;
    sc_signal< sc_lv<1> > grp_Mat2Array_fu_60_m_axi_fb_AWUSER;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_m_axi_fb_WVALID;
    sc_signal< sc_lv<8> > grp_Mat2Array_fu_60_m_axi_fb_WDATA;
    sc_signal< sc_lv<1> > grp_Mat2Array_fu_60_m_axi_fb_WSTRB;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_m_axi_fb_WLAST;
    sc_signal< sc_lv<1> > grp_Mat2Array_fu_60_m_axi_fb_WID;
    sc_signal< sc_lv<1> > grp_Mat2Array_fu_60_m_axi_fb_WUSER;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_m_axi_fb_ARVALID;
    sc_signal< sc_lv<32> > grp_Mat2Array_fu_60_m_axi_fb_ARADDR;
    sc_signal< sc_lv<1> > grp_Mat2Array_fu_60_m_axi_fb_ARID;
    sc_signal< sc_lv<32> > grp_Mat2Array_fu_60_m_axi_fb_ARLEN;
    sc_signal< sc_lv<3> > grp_Mat2Array_fu_60_m_axi_fb_ARSIZE;
    sc_signal< sc_lv<2> > grp_Mat2Array_fu_60_m_axi_fb_ARBURST;
    sc_signal< sc_lv<2> > grp_Mat2Array_fu_60_m_axi_fb_ARLOCK;
    sc_signal< sc_lv<4> > grp_Mat2Array_fu_60_m_axi_fb_ARCACHE;
    sc_signal< sc_lv<3> > grp_Mat2Array_fu_60_m_axi_fb_ARPROT;
    sc_signal< sc_lv<4> > grp_Mat2Array_fu_60_m_axi_fb_ARQOS;
    sc_signal< sc_lv<4> > grp_Mat2Array_fu_60_m_axi_fb_ARREGION;
    sc_signal< sc_lv<1> > grp_Mat2Array_fu_60_m_axi_fb_ARUSER;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_m_axi_fb_RREADY;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_m_axi_fb_BREADY;
    sc_signal< sc_logic > grp_Mat2Array_fu_60_ap_start_reg;
    ...
    void thread_grp_Mat2Array_fu_60_ap_start();
