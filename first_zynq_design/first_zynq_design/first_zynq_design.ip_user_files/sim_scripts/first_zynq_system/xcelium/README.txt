...
#
# Generated by export_simulation on Thu Jan 17 18:56:34 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './first_zynq_system.sh' script.

./first_zynq_system.sh -reset_run
...
./first_zynq_system.sh -noclean_files

For more information on the script, please type './first_zynq_system.sh -help'.
